...
export function DashboardDeleteTourButton({ tourId, tourName }: DeleteTourButtonProps) {
    ...
    const handleDelete = async () => {
        setIsDeleting(true);
        try {
            const res = await fetch(`/api/operator/tours/${tourId}`, {
                method: 'DELETE',
            });
            ...
            <AlertDialogContent className="rounded-2xl">
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        ...
                        Only draft tours can be deleted. This action cannot be undone.
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
