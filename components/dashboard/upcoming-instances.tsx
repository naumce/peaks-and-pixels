...
export async function DashboardUpcomingInstances() {
            ...
            <div className="rounded-2xl border border-border/50 bg-card overflow-hidden">
                <div className="flex items-center justify-between px-6 py-4 border-b border-border/50">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="text-base font-semibold text-foreground">Upcoming Instances</h3>
                            <p className="text-xs text-muted-foreground">Your scheduled tours</p>
                        </div>
                    </div>
                </div>
                <div className="text-center py-12 px-6">
                    ...
                    <p className="text-foreground font-medium">No tours yet</p>
            ...
            <div className="p-2">
                {!instances || instances.length === 0 ? (
                    <div className="text-center py-12 px-6">
                        ...
                        <p className="text-foreground font-medium">No upcoming instances</p>
                        <p className="text-sm text-muted-foreground mt-1">
                            Schedule tour instances from the tour management page
                        </p>
                    </div>
                ) : (
                    <div className="space-y-1">
                        {instances.map((instance: any) => {
                            ...
                            return (
                                <div
                                    key={instance.id}
                                    className="group flex items-center gap-4 rounded-xl p-4 hover:bg-secondary/50 transition-apple"
                                >
                                    {/* Date block */}
