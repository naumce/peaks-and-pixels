        ...
        <div className="space-y-6 fade-in">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-muted-foreground">Customer reservations for your tours</p>
                </div>
                ...
                <div className="p-12 rounded-2xl border border-dashed border-border text-center">
                    ...
                    <p className="text-muted-foreground">
                        {statusFilter !== 'all'
                            ...
                            : 'Bookings will appear here when customers reserve your tours'}
                    </p>
                </div>
            ) : (
